...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message: 'O horário de término deve ser pelo 1h distante do início',
      },
    ),
})

type IntervalsFormInput = z.input<typeof timeIntervalsFormSchema>
type IntervalsFormOutput = z.infer<typeof timeIntervalsFormSchema>
...
export default function ConnectCalendar() {
  ...
  async function handleSetTimeIntervals(data: any) {
    const { intervals } = data as IntervalsFormOutput
